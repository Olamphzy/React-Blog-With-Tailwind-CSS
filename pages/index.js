...
import devola from '../public/dev-ola-wave.png'
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className='min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-burtons dark:text-gray-200'>developedbyOlamphzy</h1>
          ...
          <div className='text-center p-10 py-10'>
            <h2 className='text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl'>Olanrewaju Rasheed</h2>
            <h3 className='text-2xl py-2 md-text-3xl dark:text-white'>Developer and designer.</h3>
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-gray-200'>
              Freelance providing services for programming and design contents needs. Join me down below and lets rock!!!
            </p>
          ...
          <div className='relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 overflow-hidden md:h-96 md:w-96'>
            <Image src={devola} alt={devola} layout='fill' objectFit='cover'/>
          </div>
          </div>
        </section>
        ...
        <section>
          <div>
            ...
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-200'>
              Since the beginning of my journey as a freelance designer and developer, I've done remote work for <span className='text-teal-500'>agencies</span> consulted for <span className='text-teal-500'>starting</span> and collaborated with talented people to create digital products for both bussiness and consumer use.
            </p>
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-200'>
              I offer from a wide range of services, including brand design, programming and tutoring.</p>
          </div>
        ...
        <section>
          <div>
            <h2 className='text-3xl py-1 dark:text-gray-200'>Portfolio</h2>
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-200'>
              Since the beginning of my journey as a freelance designer and developer, I've done remote work for <span className='text-teal-500'>agencies</span> consulted for <span className='text-teal-500'>starting</span> and collaborated with talented people to create digital products for both bussiness and consumer use.
            </p>
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-200'>
              I offer from a wide range of services, including brand design, programming and tutoring.
              </p>
          </div>
